...
```yaml
# Huawei Solar ELFR - Price & Tariff
    - name: "Tariff Export"
...
* **id:** Give each automation an id. This will make it editable in the GUI. In Studio Code Server leave your cursor on this line with one spacing to the colon, left click and choose "Generate UUID At Cursor". Repeat this steps for the other automation.
